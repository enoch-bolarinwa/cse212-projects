...
void SolveMaze(int[,] maze, int x, int y, List<(int, int)> currPath, List<string> results)
{
...

    {
        ...
        SolveMaze(maze, x + 1, y, currPath, results); // Down
        SolveMaze(maze, x - 1, y, currPath, results); // Up
        SolveMaze(maze, x, y + 1, currPath, results); // Right
        SolveMaze(maze, x, y - 1, currPath, results); // Left
    }
